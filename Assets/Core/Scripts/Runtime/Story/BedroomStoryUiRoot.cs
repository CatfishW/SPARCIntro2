...
namespace Blocks.Gameplay.Core.Story
{
    ...
    public sealed class BedroomStoryUiRoot : MonoBehaviour
    {
        [SerializeField] private StoryFlowChannels channels;
        [SerializeField] private BedroomStorySubtitlePresenter subtitlePresenter;
        [SerializeField] private BedroomStoryChoicePresenter choicePresenter;
        [SerializeField] private BedroomStoryPresentationState presentationState = new BedroomStoryPresentationState();

        private void Awake()
        {
            if (subtitlePresenter == null)
            {
                subtitlePresenter = CreateOverlayPresenter<BedroomStorySubtitlePresenter>("BedroomStorySubtitlePresenter");
            }

            if (choicePresenter == null)
            {
                choicePresenter = CreateOverlayPresenter<BedroomStoryChoicePresenter>("BedroomStoryChoicePresenter");
            }
        }
