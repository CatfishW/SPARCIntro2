...
namespace Blocks.Gameplay.Core.Story
{
    ...
    public sealed class BedroomStorySceneTransition : MonoBehaviour
    {
        [SerializeField] private string targetScenePath = "Assets/Core/TestScenes/ClassroomArrivalScene.unity";
        [SerializeField] private string targetSceneName = "ClassroomArrivalScene";
        ...
        {
            if (!loadRequested || string.IsNullOrWhiteSpace(targetSceneName))
            {
                return;
            }
