...
namespace Blocks.Gameplay.Core.Story
{
    ...
    public sealed class ClassroomStoryUiRoot : MonoBehaviour
    {
        [SerializeField] private StoryFlowChannels channels;
        [SerializeField] private ClassroomStorySubtitlePresenter subtitlePresenter;
        [SerializeField] private ClassroomStoryChoicePresenter choicePresenter;
        [SerializeField] private ClassroomStoryPresentationState presentationState = new ClassroomStoryPresentationState();

        private void Awake()
        {
            if (subtitlePresenter == null)
            {
                subtitlePresenter = CreateOverlayPresenter<ClassroomStorySubtitlePresenter>("ClassroomStorySubtitlePresenter");
            }

            if (choicePresenter == null)
            {
                choicePresenter = CreateOverlayPresenter<ClassroomStoryChoicePresenter>("ClassroomStoryChoicePresenter");
            }
        }
